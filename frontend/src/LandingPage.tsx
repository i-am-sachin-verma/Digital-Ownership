      ...
      <nav className="navbar">
        <div className="nav-brand">
          <svg width="26" height="26" viewBox="0 0 410 404" fill="none">
            ...
            <defs>
              <linearGradient id="va" x1="6" y1="33" x2="235" y2="344" gradientUnits="userSpaceOnUse">
                <stop stopColor="#41D1FF"/><stop offset="1" stopColor="#BD34FE"/>
              </linearGradient>
              <linearGradient id="vb" x1="194.651" y1="8.818" x2="236.076" y2="292.989" gradientUnits="userSpaceOnUse">
                <stop stopColor="#FF3CAC"/><stop offset="1" stopColor="#784BA0"/>
              </linearGradient>
            </defs>
          </svg>
          Digital Ownership
