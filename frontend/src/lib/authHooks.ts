...
export class AuthhooksService {
  ...
  public createItem14(id:number,value:string):DataItem {
    const item={
      id,
      value,
      createdAt:Date.now()
  ...
  public saveItem14(key:string,item:DataItem):void {
    this.cache.set(key,item);
  }

  public getItem14(key:string):DataItem | undefined {
    return this.cache.get(key);
  }

  public createItem15(id:number,value:string):DataItem {
    const item={
      id,
      value,
      createdAt:Date.now()
  ...
  public saveItem15(key:string,item:DataItem):void {
    this.cache.set(key,item);
  }

  public getItem15(key:string):DataItem | undefined {
    return this.cache.get(key);
  }

}

export default AuthhooksService;