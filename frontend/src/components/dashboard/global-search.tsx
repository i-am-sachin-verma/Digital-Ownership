...
const GlobalSearchCatalog: GlobalSearchResult[] = [
  { id: "r1", label: "Search", kind: "entity", detail: "Primary lookup target with fast access.", score: 96 },
  { id: "r2", label: "Layer", kind: "collection", detail: "Recently opened item with strong relevance.", score: 91 },
  { id: "r3", label: "Global", kind: "wallet", detail: "Wallet-bound record with high confidence.", score: 88 },
  { id: "r4", label: "Entity", kind: "history", detail: "Cached item from recent activity.", score: 84 },
  { id: "r5", label: "Lookup", kind: "notification", detail: "Actionable alert with shortcuts.", score: 79 },
  { id: "r6", label: "Result", kind: "route", detail: "Related search path and navigation hit.", score: 74 },
];
...
function rankResult(query: string, result: GlobalSearchResult) {
  ...
  return (
    <section className="mx-auto grid max-w-6xl gap-6 p-6">
      <header className="grid gap-2">
        ...
        <h2 className="text-2xl font-semibold text-slate-900">"Create a Dashboard Search Layer with Global Entity Lookup and Result Prioritization"</h2>
        <p className="max-w-4xl text-sm text-slate-600">"Build a search experience that finds proposals, assets, transactions, and NFTs from one global dashboard search box. * Search across multiple entity types * Prioritize recent and relevant results * Display entity labels and quick actions * Support keyboard shortcuts and focus states * Keep search result rows reusable"</p>
      </header>
