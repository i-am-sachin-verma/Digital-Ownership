...
function SectionHeader({ title, description }: Pick<AirdropBannerProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Airdrop Banner"}</h2>
...
export interface AirdropBannerProps extends AirdropBannerProps {
  items?: DataItem[];
}

export default function AirdropBanner({
  title = "Airdrop Banner",
...
export const AirdropVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const AirdropSizes = ["sm", "md", "lg"] as const;
export function AirdropIsInteractive(disabled?: boolean) { return !disabled; }
export function AirdropDisplayLabel(index: number) { return "Airdrop item " + String(index + 1); }
