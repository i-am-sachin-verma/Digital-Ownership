...
function SectionHeader({ title, description }: Pick<GovernanceProposalCardProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Governance Proposal Card"}</h2>
...
export const GovernanceProposalVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const GovernanceProposalSizes = ["sm", "md", "lg"] as const;
export function GovernanceProposalIsInteractive(disabled?: boolean) { return !disabled; }
export function GovernanceProposalDisplayLabel(index: number) { return "GovernanceProposal item " + String(index + 1); }
