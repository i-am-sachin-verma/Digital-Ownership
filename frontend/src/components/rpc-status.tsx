...
function SectionHeader({ title, description }: Pick<RpcStatusIndicatorProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "RPC Status Indicator"}</h2>
...
export interface RpcStatusIndicatorProps extends RpcStatusIndicatorProps {
  items?: DataItem[];
}

export default function RpcStatusIndicator({
  title = "RPC Status Indicator",
...
export const RpcStatusIndicatorVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const RpcStatusIndicatorSizes = ["sm", "md", "lg"] as const;
export function RpcStatusIndicatorIsInteractive(disabled?: boolean) { return !disabled; }
export function RpcStatusIndicatorDisplayLabel(index: number) { return "RpcStatusIndicator item " + String(index + 1); }
