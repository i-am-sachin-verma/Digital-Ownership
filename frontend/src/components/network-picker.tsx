...
function SectionHeader({ title, description }: Pick<NetworkSelectorProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Network Selector"}</h2>
...
export interface NetworkSelectorProps extends NetworkSelectorProps {
  items?: DataItem[];
}
...
export const NetworkSelectorVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const NetworkSelectorSizes = ["sm", "md", "lg"] as const;
export function NetworkSelectorIsInteractive(disabled?: boolean) { return !disabled; }
export function NetworkSelectorDisplayLabel(index: number) { return "NetworkSelector item " + String(index + 1); }
