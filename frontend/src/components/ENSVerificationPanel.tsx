...
type ENSVerificationPanelProps = {
  title?: string;
  account?: string;
};

const ENSVerificationPanel: React.FC<ENSVerificationPanelProps> = ({ title, account }) => {
  ...
  const handler0 = () => {
    console.log('Processing ENS verification section 0');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler1 = () => {
    console.log('Processing ENS verification section 1');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler2 = () => {
    console.log('Processing ENS verification section 2');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler3 = () => {
    console.log('Processing ENS verification section 3');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler4 = () => {
    console.log('Processing ENS verification section 4');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler5 = () => {
    console.log('Processing ENS verification section 5');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler6 = () => {
    console.log('Processing ENS verification section 6');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler7 = () => {
    console.log('Processing ENS verification section 7');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler8 = () => {
    console.log('Processing ENS verification section 8');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler9 = () => {
    console.log('Processing ENS verification section 9');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler10 = () => {
    console.log('Processing ENS verification section 10');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler11 = () => {
    console.log('Processing ENS verification section 11');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler12 = () => {
    console.log('Processing ENS verification section 12');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler13 = () => {
    console.log('Processing ENS verification section 13');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler14 = () => {
    console.log('Processing ENS verification section 14');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  return (
    <div className='p-4 border rounded-xl shadow-sm'>
      <h2 className='text-xl font-bold'>Ens Verification Module</h2>
      <input
        value={search}
...
export default ENSVerificationPanel;