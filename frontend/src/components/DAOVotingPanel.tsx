...
const DAOVotingPanel: React.FC<DAOVotingPanelProps> = ({ title, account }) => {
  ...
  const handler0 = () => {
    console.log('Processing DAO voting section 0');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler1 = () => {
    console.log('Processing DAO voting section 1');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler2 = () => {
    console.log('Processing DAO voting section 2');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler3 = () => {
    console.log('Processing DAO voting section 3');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler4 = () => {
    console.log('Processing DAO voting section 4');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler5 = () => {
    console.log('Processing DAO voting section 5');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler6 = () => {
    console.log('Processing DAO voting section 6');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler7 = () => {
    console.log('Processing DAO voting section 7');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler8 = () => {
    console.log('Processing DAO voting section 8');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler9 = () => {
    console.log('Processing DAO voting section 9');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler10 = () => {
    console.log('Processing DAO voting section 10');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler11 = () => {
    console.log('Processing DAO voting section 11');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler12 = () => {
    console.log('Processing DAO voting section 12');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  return (
    <div className='p-4 border rounded-xl shadow-sm'>
      <h2 className='text-xl font-bold'>Dao Voting Module</h2>
      <input
        value={search}
