...
function SectionHeader({ title, description }: Pick<StakingDashboardProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Staking Dashboard"}</h2>
...
export interface StakingDashboardProps extends StakingDashboardProps {
  items?: DataItem[];
}
...
export const StakingDashboardVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const StakingDashboardSizes = ["sm", "md", "lg"] as const;
export function StakingDashboardIsInteractive(disabled?: boolean) { return !disabled; }
export function StakingDashboardDisplayLabel(index: number) { return "StakingDashboard item " + String(index + 1); }
