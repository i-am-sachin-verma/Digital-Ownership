...
function SectionHeader({ title, description }: Pick<GasFeeEstimatorProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Gas Fee Estimator"}</h2>
...
export interface GasFeeEstimatorProps extends GasFeeEstimatorProps {
  items?: DataItem[];
}
...
export const GasFeeEstimatorVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const GasFeeEstimatorSizes = ["sm", "md", "lg"] as const;
export function GasFeeEstimatorIsInteractive(disabled?: boolean) { return !disabled; }
export function GasFeeEstimatorDisplayLabel(index: number) { return "GasFeeEstimator item " + String(index + 1); }
