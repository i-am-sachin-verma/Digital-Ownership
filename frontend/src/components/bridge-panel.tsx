...
function SectionHeader({ title, description }: Pick<BridgeCardProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Bridge Card"}</h2>
...
export interface BridgeCardProps extends BridgeCardProps {
  items?: DataItem[];
}
...
export const BridgeVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const BridgeSizes = ["sm", "md", "lg"] as const;
export function BridgeIsInteractive(disabled?: boolean) { return !disabled; }
export function BridgeDisplayLabel(index: number) { return "Bridge item " + String(index + 1); }
