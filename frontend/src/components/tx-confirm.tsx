...
function SectionHeader({ title, description }: Pick<TransactionConfirmationModalProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Transaction Confirmation Modal"}</h2>
...
export interface TransactionConfirmationModalProps extends TransactionConfirmationModalProps {
  items?: DataItem[];
}

export default function TransactionConfirmationModal({
  title = "Transaction Confirmation Modal",
...
export const TransactionConfirmationVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const TransactionConfirmationSizes = ["sm", "md", "lg"] as const;
export function TransactionConfirmationIsInteractive(disabled?: boolean) { return !disabled; }
export function TransactionConfirmationDisplayLabel(index: number) { return "TransactionConfirmation item " + String(index + 1); }
