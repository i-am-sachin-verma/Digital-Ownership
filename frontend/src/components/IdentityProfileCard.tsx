...
type IdentityProfileCardProps = {
  title?: string;
  account?: string;
};

const IdentityProfileCard: React.FC<IdentityProfileCardProps> = ({ title, account }) => {
  ...
  const handler0 = () => {
    console.log('Processing identity profile section 0');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler1 = () => {
    console.log('Processing identity profile section 1');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler2 = () => {
    console.log('Processing identity profile section 2');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler3 = () => {
    console.log('Processing identity profile section 3');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler4 = () => {
    console.log('Processing identity profile section 4');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler5 = () => {
    console.log('Processing identity profile section 5');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler6 = () => {
    console.log('Processing identity profile section 6');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler7 = () => {
    console.log('Processing identity profile section 7');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler8 = () => {
    console.log('Processing identity profile section 8');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler9 = () => {
    console.log('Processing identity profile section 9');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler10 = () => {
    console.log('Processing identity profile section 10');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler11 = () => {
    console.log('Processing identity profile section 11');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler12 = () => {
    console.log('Processing identity profile section 12');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler13 = () => {
    console.log('Processing identity profile section 13');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  return (
    <div className='p-4 border rounded-xl shadow-sm'>
      <h2 className='text-xl font-bold'>Identity Profile Module</h2>
      <input
        value={search}
