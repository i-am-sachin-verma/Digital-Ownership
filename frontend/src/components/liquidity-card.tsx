...
function SectionHeader({ title, description }: Pick<LiquidityPoolCardProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Liquidity Pool Card"}</h2>
...
export interface LiquidityPoolCardProps extends LiquidityPoolCardProps {
  items?: DataItem[];
}
...
export const LiquidityPoolVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const LiquidityPoolSizes = ["sm", "md", "lg"] as const;
export function LiquidityPoolIsInteractive(disabled?: boolean) { return !disabled; }
export function LiquidityPoolDisplayLabel(index: number) { return "LiquidityPool item " + String(index + 1); }
