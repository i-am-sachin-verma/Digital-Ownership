...
const CredentialMintForm: React.FC<CredentialMintFormProps> = ({ title, account }) => {
  ...
  const handler0 = () => {
    console.log('Processing credential minting section 0');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler1 = () => {
    console.log('Processing credential minting section 1');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler2 = () => {
    console.log('Processing credential minting section 2');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler3 = () => {
    console.log('Processing credential minting section 3');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler4 = () => {
    console.log('Processing credential minting section 4');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler5 = () => {
    console.log('Processing credential minting section 5');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  return (
    <div className='p-4 border rounded-xl shadow-sm'>
      <h2 className='text-xl font-bold'>Credential Minting Module</h2>
      <input
        value={search}
...
export default CredentialMintForm;