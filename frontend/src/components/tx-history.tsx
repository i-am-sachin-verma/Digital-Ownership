...
function SectionHeader({ title, description }: Pick<TransactionHistoryTableProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Transaction History Table"}</h2>
...
export interface TransactionHistoryTableProps extends TransactionHistoryTableProps {
  items?: DataItem[];
}
...
export const TransactionHistoryVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const TransactionHistorySizes = ["sm", "md", "lg"] as const;
export function TransactionHistoryIsInteractive(disabled?: boolean) { return !disabled; }
export function TransactionHistoryDisplayLabel(index: number) { return "TransactionHistory item " + String(index + 1); }
