...
function SectionHeader({ title, description }: Pick<ActivityFeedProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Activity Feed"}</h2>
...
export interface ActivityFeedProps extends ActivityFeedProps {
  items?: DataItem[];
}
...
export const ActivityFeedVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const ActivityFeedSizes = ["sm", "md", "lg"] as const;
export function ActivityFeedIsInteractive(disabled?: boolean) { return !disabled; }
export function ActivityFeedDisplayLabel(index: number) { return "ActivityFeed item " + String(index + 1); }
