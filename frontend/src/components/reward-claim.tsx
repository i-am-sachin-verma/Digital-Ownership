...
export interface ClaimRewardsCardProps {
  className?: string;
  title?: string;
  description?: string;
  disabled?: boolean;
...
function SectionHeader({ title, description }: Pick<ClaimRewardsCardProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Claim Rewards Card"}</h2>
...
export interface ClaimRewardsCardProps extends ClaimRewardsCardProps {
  items?: DataItem[];
}

export default function ClaimRewardsCard({
  title = "Claim Rewards Card",
...
export const ClaimRewardsVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const ClaimRewardsSizes = ["sm", "md", "lg"] as const;
export function ClaimRewardsIsInteractive(disabled?: boolean) { return !disabled; }
export function ClaimRewardsDisplayLabel(index: number) { return "ClaimRewards item " + String(index + 1); }
