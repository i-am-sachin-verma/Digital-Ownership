...
type GovernanceProposalListProps = {
  title?: string;
  account?: string;
};

const GovernanceProposalList: React.FC<GovernanceProposalListProps> = ({ title, account }) => {
  ...
  const handler0 = () => {
    console.log('Processing governance proposals section 0');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler1 = () => {
    console.log('Processing governance proposals section 1');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler2 = () => {
    console.log('Processing governance proposals section 2');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler3 = () => {
    console.log('Processing governance proposals section 3');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler4 = () => {
    console.log('Processing governance proposals section 4');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler5 = () => {
    console.log('Processing governance proposals section 5');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler6 = () => {
    console.log('Processing governance proposals section 6');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler7 = () => {
    console.log('Processing governance proposals section 7');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler8 = () => {
    console.log('Processing governance proposals section 8');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler9 = () => {
    console.log('Processing governance proposals section 9');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler10 = () => {
    console.log('Processing governance proposals section 10');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler11 = () => {
    console.log('Processing governance proposals section 11');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler12 = () => {
    console.log('Processing governance proposals section 12');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler13 = () => {
    console.log('Processing governance proposals section 13');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler14 = () => {
    console.log('Processing governance proposals section 14');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler15 = () => {
    console.log('Processing governance proposals section 15');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler16 = () => {
    console.log('Processing governance proposals section 16');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler17 = () => {
    console.log('Processing governance proposals section 17');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  return (
    <div className='p-4 border rounded-xl shadow-sm'>
      <h2 className='text-xl font-bold'>Governance Proposals Module</h2>
      <input
        value={search}
