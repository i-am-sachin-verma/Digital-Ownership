...
function SectionHeader({ title, description }: Pick<PortfolioChartCardProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Portfolio Chart Card"}</h2>
...
export interface PortfolioChartCardProps extends PortfolioChartCardProps {
  items?: DataItem[];
}

export default function PortfolioChartCard({
  title = "Portfolio Chart Card",
...
export const PortfolioChartVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const PortfolioChartSizes = ["sm", "md", "lg"] as const;
export function PortfolioChartIsInteractive(disabled?: boolean) { return !disabled; }
export function PortfolioChartDisplayLabel(index: number) { return "PortfolioChart item " + String(index + 1); }
