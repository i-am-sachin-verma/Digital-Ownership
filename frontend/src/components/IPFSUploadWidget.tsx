...
const IPFSUploadWidget: React.FC<IPFSUploadWidgetProps> = ({ title, account }) => {
  ...
  const handler0 = () => {
    console.log('Processing IPFS storage section 0');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler1 = () => {
    console.log('Processing IPFS storage section 1');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler2 = () => {
    console.log('Processing IPFS storage section 2');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler3 = () => {
    console.log('Processing IPFS storage section 3');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler4 = () => {
    console.log('Processing IPFS storage section 4');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler5 = () => {
    console.log('Processing IPFS storage section 5');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler6 = () => {
    console.log('Processing IPFS storage section 6');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler7 = () => {
    console.log('Processing IPFS storage section 7');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler8 = () => {
    console.log('Processing IPFS storage section 8');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler9 = () => {
    console.log('Processing IPFS storage section 9');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  const handler10 = () => {
    console.log('Processing IPFS storage section 10');
    setLoading(true);
    setTimeout(() => {
      setLoading(false);
    }, 100);
  ...
  return (
    <div className='p-4 border rounded-xl shadow-sm'>
      <h2 className='text-xl font-bold'>Ipfs Storage Module</h2>
      <input
        value={search}
