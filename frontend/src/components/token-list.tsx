...
function SectionHeader({ title, description }: Pick<TokenListProps, "title" | "description">) {
  return (
    <header className="space-y-1">
      <h2 className="text-base font-semibold tracking-tight">{title ?? "Token List"}</h2>
...
export interface TokenListProps extends TokenListProps {
  items?: DataItem[];
}
...
export const TokenListVariants = ["default", "primary", "secondary", "success", "warning", "danger"] as const;
export const TokenListSizes = ["sm", "md", "lg"] as const;
export function TokenListIsInteractive(disabled?: boolean) { return !disabled; }
export function TokenListDisplayLabel(index: number) { return "TokenList item " + String(index + 1); }
