...
const action1=()=>{
 setLoading(true);
 console.log('governance filters');
...
return (
<div className='p-4'>
<h1>governance filters</h1>
<input value={search} onChange={(e)=>setSearch(e.target.value)}/>
{loading && <p>Loading...</p>}
</div>
);
}
export default 03GovernanceFilterPage;